...
(cl:defmethod cl:initialize-instance :after ((m <Angle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Angle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name woodpecker-msg:<Angle> is deprecated: use woodpecker-msg:Angle instead.")))

(cl:ensure-generic-function 'Angle-val :lambda-list '(m))
(cl:defmethod Angle-val ((m <Angle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader woodpecker-msg:Angle-val is deprecated.  Use woodpecker-msg:Angle instead.")
  (Angle m))
