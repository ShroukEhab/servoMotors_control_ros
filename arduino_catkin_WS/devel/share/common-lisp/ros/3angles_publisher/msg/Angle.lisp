...
(cl:defmethod cl:initialize-instance :after ((m <Angle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Angle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name 3angles_publisher-msg:<Angle> is deprecated: use 3angles_publisher-msg:Angle instead.")))

(cl:ensure-generic-function 'Angle-val :lambda-list '(m))
(cl:defmethod Angle-val ((m <Angle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader 3angles_publisher-msg:Angle-val is deprecated.  Use 3angles_publisher-msg:Angle instead.")
  (Angle m))
