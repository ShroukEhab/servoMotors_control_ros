...
namespace derived_object_msgs
{
  ...
  class ObjectWithCovarianceArray : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "derived_object_msgs/ObjectWithCovarianceArray"; };
    virtual const char * getMD5() override { return "59dfdf4ed3407a2558ccbc7f5732bf46"; };
